...
module Lexer (module U : sig
  type token =
    ...
    | SEMICOLON |COLON |DOUBLE_COLON| COMMA| PERIOD| SLASH
    | ASTERISK| QUOTIENT| PLUS| MINUS| TILDE| GT| IMPORTANT
    | ATTR_EQUALS | ATTR_INCLUDES| ATTR_DASHMATCH| ATTR_PREFIX
    | ATTR_SUFFIX | ATTR_SUBSTRING| URI| STRING of string
    | IDENT of string | NTH of string | HASH of string
    | VAR of string | SEL_FUNC of string | TERM_FUNC of string
    | <quantity_t> QUANTITY
