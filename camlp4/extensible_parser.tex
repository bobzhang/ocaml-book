...
\inputminted[fontsize=\scriptsize, ]{ocaml}{camlp4/code/simple_calc.ml}
...
\inputminted[fontsize=\scriptsize, ]{ocaml}{camlp4/code/parser1.ml}
...
\inputminted[fontsize=\scriptsize, ]{ocaml}{camlp4/code/parser2.ml}
...
\inputminted[fontsize=\scriptsize, firstline=1,lastline=10]{ocaml}{camlp4/code/extend_trans.ml}
The processed code is as follows:
\inputminted[fontsize=\scriptsize, firstline=11]{ocaml}{camlp4/code/extend_trans.ml}
...
\item Grammar modification \\ When you extend an entry, by default
  ...
  \inputminted[fontsize=\scriptsize, firstline=1,lastline=36]{ocaml}{camlp4/code/grammar.ml}
  \inputminted[fontsize=\scriptsize, firstline=37,lastline=56]{ocaml}{camlp4/code/grammar.ml}
  This extends the first level ``add''. you can double check by
  printing the result


  When you want to create a new level in the last position 
  \inputminted[fontsize=\scriptsize, firstline=57,lastline=78]{ocaml}{camlp4/code/grammar.ml}


  When you want to insert in the level ``mult'' in the first position 
  \inputminted[fontsize=\scriptsize, firstline=79,lastline=99]{ocaml}{camlp4/code/grammar.ml}
  

  When you want to insert a new level before ``mult'' 
  \inputminted[fontsize=\scriptsize, firstline=100,lastline=123]{ocaml}{camlp4/code/grammar.ml}
...
\inputminted[fontsize=\scriptsize, ]{ocaml}{camlp4/code/expr_parse_tree.ml}
...
\inputminted[fontsize=\scriptsize, ]{ocaml}{camlp4/code/syntax_extension_a.ml}
